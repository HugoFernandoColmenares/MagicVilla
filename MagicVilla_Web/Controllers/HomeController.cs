...
namespace MagicVilla_Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index(int pageNumber = 1)
        {
            ...
            VillaPaginadoViewModel villaPaginadoVM = new VillaPaginadoViewModel();
            ...
            if (response != null && response.IsExitoso)
            {
                ...
                villaPaginadoVM = new VillaPaginadoViewModel()
                {
                    VillaList = villaList,
                ...
                if (pageNumber > 1) villaPaginadoVM.Previo = "";
                if (villaPaginadoVM.TotalPaginas <= pageNumber) villaPaginadoVM.Siguiente = "disabled";
            }
            return View(villaPaginadoVM);
        }
